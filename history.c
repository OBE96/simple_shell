...
/**
 * write_history - creates a file, or use an existing file
 * @info: parameter of struct
 ...
 * Return: histcount on success, return 0 if otherwise
 */
...
/**
 * renumber_history - history linked list is renumberd  after changes
